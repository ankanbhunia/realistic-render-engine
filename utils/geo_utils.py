...
# Enable the Wavefront OBJ add-on
# The module name for OBJ import is 'io_scene_obj'
...
def simulate_to_get_stable_pose(blend_file_path, plane_height = 5, rot_degree = [0,0,0], num_frames = 250):
    ...
    #bpy.ops.wm.save_as_mainfile(filepath="/disk/nfs/gazinasvolume2/s2514643/sketch-assembly-AD/output_folder2/transformed.blend")
